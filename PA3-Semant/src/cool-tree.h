...
public:
   ...
   virtual void check_inherit(ClassTable &g) = 0;
   virtual void check_type(ClassTable &g) = 0;
...
public:
   ...
   virtual Feature find_attr(const char *attr) = 0;
   virtual Feature find_method(const char *method) = 0;
...
public:
   ...
   virtual void check_type(ClassTable &g) = 0;
   virtual bool equal_attr(const char *attr) = 0;
   virtual bool equal_method(const char *method) = 0;
   virtual Symbol get_method_name() = 0;
   virtual Formals get_formals() = 0;
   virtual Symbol get_return_type() = 0;
   virtual Symbol get_attr_type() = 0;
...
public:
   ...
   virtual Symbol get_formal_name() = 0;
#ifdef Formal_EXTRAS
   Formal_EXTRAS
#endif
};
...
public:
   ...
   void check_inherit(ClassTable &g);
   void check_type(ClassTable &g);
...
public:
   ...
   Feature find_attr(const char *attr);
   Feature find_method(const char *method);
...
public:
   ...
   void dump(ostream& stream, int n);
   void check_type(ClassTable &g);
   bool equal_attr(const char *) { return false; }
   bool equal_method(const char *method)
        { return strcmp(name->get_string(), method) == 0; }
   Formals get_formals() { return formals; }
   Symbol get_method_name(){ return name; }
   Symbol get_return_type() { return return_type; }
   Symbol get_attr_type() { return NULL; }
...
public:
   ...
   void dump(ostream& stream, int n);
   void check_type(ClassTable &g);
   bool equal_attr(const char *attr)
        { return strcmp(attr, name->get_string()) == 0; }
   bool equal_method(const char *) { return false; }
   Symbol get_method_name(){return NULL;}
   Formals get_formals() { return NULL; }
   Symbol get_return_type() { return NULL; }
   Symbol get_attr_type() { return type_decl; }
